  ...
  methods: {
    ...
    deleteClick(data) {
      ...
      this.modalAlert = {
        showModal: true,
        type: 'confirm',
        title: `คุณยืนยันการลบทะเบียนหนังสือ`,
        ...
        afterPressAgree() {
          ...
          .then(() => { 
            ...
            _this.modalAlert = {
              showModal: true,
              type: 'success',
              title: 'ทำการลบทะเบียนหนังสือสำเร็จแล้ว',
              msgSuccess: true,
              afterPressAgree() {
                _this.apiDepartment()
              }
