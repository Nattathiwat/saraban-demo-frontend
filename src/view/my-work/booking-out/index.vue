                ...
                <tr class="tbody-row pointer" :class="index % 2 != 0 ? 'color-tr1' : 'color-tr2'" @click="editClick(item)">
                  ...
                  <td class="col7">
                    <div class="group-show">
                      ...
                      <div class="show-detail" v-show="item.booking_follows.length > 0">
                        {{ creater_name(item.booking_follows) }}</div>
                    </div>
                  </td>
                  <td class="col8">{{ item.status_name }}</td>
                </tr>
                <template v-if="item.select && item.register_count > 1"
                  v-for="(item2, index2) in item.booking_registers" :key="index2">
                  <tr class="tbody-row"
