          ...
          <div class="group-detail">
            <div class="d-flex justify-content-between align-items-center mb-4">
              ...
              <div>
                <button
                  type="button"
                  class="button-after button-primary"
                  @click="step -= 1"
                  v-show="step != 1"
                >
                ...
                <button
                  type="submit"
                  class="button-save2 button-primary"
                  v-show="step == 3"
                  @click="flag = 2"
                >
                  <img
                ...
                <button
                  type="button"
                  class="button-next button-primary"
                  @click="step += 1"
                  v-show="step != 3"
                >
                  ถัดไป
            ...
            <div class="border">
              <div class="group-between">
                <div class="group-input">
                  ...
                  <cpn-input
                    v-model="data.bookout.book_type_name"
                ...
                <div class="group-input">
                  ...
                  <cpn-input
                    v-model="data.bookout.book_regis_name"
              ...
              <div class="group-between">
                <div class="group-input">
                  ...
                  <cpn-input
                    v-model="data.bookout.secret_name"
                ...
                <div class="group-input">
                  ...
                  <cpn-input
                    v-model="data.bookout.speed_name"
                ...
                <div class="group-input">
                  ...
                  <cpn-input
                    v-model="data.bookout.book_out_document_number"
                ...
                <div class="group-input">
                  ...
                  <cpn-input
                    v-model="data.bookout.as_of_date"
            ...
            <div v-if="step == 1">
              ...
              <div class="group-input">
                <div class="name">
                  รายละเอียดตามเอกสารที่ส่งมาด้วย <span class="required">*</span>
                </div>
                <cpn-textArea
                  v-model="data.detail"
                  name="detail"
            ...
            <div v-if="step == 2">
              ...
              <div class="group-input">
                ...
                <cpn-select
                  v-model="data.send_type_id"
                  name="send_type_id"
                  rules="required"
                  :disabled="errorFileSize"
              ...
              <div class="group-input">
                ...
                <div class="group-recommend">
                  <cpn-input
                    ...
                    :rules="errorFileSize || data.send_type_id == 2 ? 'required' : ''"
                    placeholder="กรุณาระบุ"
                  />
              ...
              <div class="group-input">
                ...
                <div class="d-flex" v-if="data.main_file_name">
                  ...
                  <button
                    ...
                    @click="
                      previewFile({
                        filename: data.main_file_name,
                        link: data.main_file_path ? backendport + '/' + data.main_file_path : '',
                      })
                    "
                  >
              ...
              <div class="group-input">
                ...
                <div class="d-flex mb-2" v-if="data.copy_main_file_name">
                  <cpn-input
                    v-model="data.copy_main_file_name"
                  ...
                  <button
                    ...
                    @click="
                      previewFile({
                        filename: data.copy_main_file_name,
                        link: data.copy_main_file_path
                          ? backendport + '/' + data.copy_main_file_path
                          : '',
                      })
                    "
                  >
                ...
                <div
                  v-if="
                    data?.attachments.filter((el) => el.flag != 'delete')?.length > 0 ||
                    data.copy_main_file_name
                  "
                >
                  <div
            ...
            <div v-if="step == 3">
              ...
              <div class="group-input mt-4">
                <div class="name">
                  ถึง / To <span class="required">*</span> (สามารถระบุได้มากกว่า 1 อีเมล
                  โดยคั่นแต่ละอีเมลด้วยสัญลักษณ์ ,)
                </div>
                <cpn-input
                  v-model="data.to"
                  name="to"
              ...
              <div class="group-input mt-4">
                <div class="name">
                  สำเนาถึง / Cc (สามารถระบุได้มากกว่า 1 อีเมล โดยคั่นแต่ละอีเมลด้วยสัญลักษณ์ ,)
                </div>
                <cpn-input v-model="data.cc" name="cc" placeholder="อีเมลผู้รับจดหมาย" />
              </div>
              <div class="group-input mt-4">
                <div class="name">
                  สำเนาลับถึง / BCc (สามารถระบุได้มากกว่า 1 อีเมล โดยคั่นแต่ละอีเมลด้วยสัญลักษณ์ ,)
                </div>
                                          ...
                                          >
                                            <strong
                                              ><span style="font-size: 14px; font-weight: 400"
                                                >ระบบสารบรรณอิเล็กทรอนิกส์</span
                                              ></strong
                                            >
                                          </p>
                                        </div>
                                        ...
                                        >
                                          ...
                                          >
                                            <p
                                              ...
                                              "
                                            >
                                              <a :href="data.link" title="ลิงก์ดาวน์โหลดเอกสาร">{{
                                                data.link
                                              }}</a>
                                            </p>
                                          </div>
                                          ...
                                          <div
                                            style="
                                              ...
                                              margin-bottom: 20px;
                                              margin-top: 20px;
                                              border-bottom: #030303 dashed 1px;
                                              padding-bottom: 15px;
                                            "
                                          >
                                            <p
          ...
          <div class="modal-size">
            ...
            <div class="modal-detail">
              <div class="group-input">
                ...
                <cpn-autoComplete
                  v-model="modalTemplate.message_format"
                  name="message_format"
            ...
            <div class="group-footer">
              <button
                type="button"
                @click="modalTemplate.showModal = false"
  ...
  methods: {
    ...
    modalTemplateClick() {
      if (this.modalTemplate.message_format) {
        ...
        // .then((response) => {
        this.data.message =
          "ขอนำส่งหนังสือ เลขที่ นร0501/48, เรื่อง ทดสอบ, ลงวันที่ 14 กุมภาพันธ์ 2566";
    ...
    callApiSave() {
      ...
      this.axios
        .post(`/book-out-external/email-information`, dataSave)
        .then((response) => {
          this.showLoading = false;
          this.modalAlert = {
            showModal: true,
            type: "success",
            title: this.flag == 1 ? "ทำการบันทึกร่างสำเร็จแล้ว" : "ทำการบันทึกและส่งสำเร็จแล้ว",
            msgSuccess: true,
            afterPressAgree() {
              _this.flag == 1 ? _this.apiDetail() : _this.back();
            },
          };
        })
        .catch((error) => {
    ...
    apiDetail() {
      this.showLoading = true;
      this.axios
        .get(`/book-out-external/book-out-automail/${this.$route.params.id}`)
        .then((response) => {
          this.showLoading = false;
          ...
          this.axios({
            ...
            .then((response2) => {
              const blob = new Blob([response2.data], {
                type: this.assetsUtils.getTypeFile(localStorage.getItem("filename")),
              });
