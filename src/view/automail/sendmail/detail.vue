            ...
            <div class="border">
              <div class="group-between">
                <div class="group-input">
                  ...
                  <cpn-input v-model="data.bookout.book_type_name" name="bookout.book_type_name" :disabled="true"
                    placeholder="กรุณาระบุ" />
                </div>
                <div class="group-input">
                  <div class="name">ทะเบียน</div>
                  <cpn-input v-model="data.bookout.book_regis_name" name="bookout.book_regis_name" :disabled="true"
                    placeholder="กรุณาระบุ" />
                </div>
              </div>
              <div class="group-between">
                <div class="group-input">
                  ...
                  <cpn-input v-model="data.bookout.secret_name" name="bookout.secret_name" :disabled="true"
                    placeholder="กรุณาระบุ" />
                </div>
                <div class="group-input">
                  <div class="name">ความเร่งด่วน</div>
                  <cpn-input v-model="data.bookout.speed_name" name="bookout.speed_name" :disabled="true"
                    placeholder="กรุณาระบุ" />
                </div>
                <div class="group-input">
                  <div class="name">เลขที่ออก สลค.</div>
                  <cpn-input v-model="data.bookout.book_out_document_number" name="bookout.book_out_document_number"
                    :disabled="true" placeholder="กรุณาระบุ" />
                </div>
                <div class="group-input">
                  <div class="name">ลงวันที่</div>
                  <cpn-input v-model="data.bookout.as_of_date" name="bookout.as_of_date" :disabled="true"
                    placeholder="กรุณาระบุ" />
                </div>
              </div>
              <div class="group-between">
                <div class="group-input">
                  ...
                  <cpn-input v-model="data.bookout.from" name="bookout.from" :disabled="true" placeholder="กรุณาระบุ" />
                </div>
                <div class="group-input">
                  <div class="name">ถึง</div>
                  <cpn-input v-model="data.bookout.to" name="bookout.to" :disabled="true" placeholder="กรุณาระบุ" />
                </div>
              </div>
              <div class="group-between">
                <div class="group-input">
                  <div class="name">ชื่อเรื่อง</div>
                  <cpn-input v-model="data.bookout.subject" name="bookout.subject" :disabled="true"
                    placeholder="กรุณาระบุ" />
                </div>
              </div>
            </div>
            <div v-if="step == 1">
              <div class="group-input mt-4">
                ...
                <div class="group-recommend mb-3">
                  <cpn-input v-model="data.greeting" name="greeting" class="input-recommend" rules="required"
                    placeholder="กรุณาระบุ" />
              ...
              <div class="group-input">
                ...
                <cpn-input v-model="data.bookout.greeting" name="bookout-greeting" placeholder="ผู้รับหนังสือ" />
              </div>
              <div class="group-input">
                ...
                <cpn-textArea v-model="data.message" name="message" rows="15" rules="required"
                  placeholder="เนื้อความจดหมาย" />
              </div>
              <div class="group-input">
                <div class="name">รายละเอียดตามเอกสารที่ส่งมาด้วย <span class="required">*</span></div>
                <cpn-textArea v-model="data.detail" name="detail" rules="required" rows="2" placeholder="กรุณาระบุ" />
              </div>
              <div class="group-input">
                <div class="name">คำลงท้าย <span class="required">*</span></div>
                <cpn-input v-model="data.signature" name="signature" rules="required" placeholder="กรุณาระบุ" />
              </div>
              <div class="group-input">
                <div class="name">ชื่อหน่วยงานที่ส่งหนังสือ <span class="required">*</span></div>
                <cpn-input v-model="data.department_name" name="department_name" rules="required"
                  placeholder="กรุณาระบุ" />
              </div>
              <div class="group-input">
                <div class="name">ข้อมูลผู้ติดต่อ <span class="required">*</span></div>
                <div class="mb-3">
                  <cpn-input v-model="data.contact_name" name="contact_name" rules="required"
                    placeholder="ชื่อส่วนราชการเจ้าของเรื่องหรือหน่วยงานที่ออกหนังสือ" />
                </div>
                <cpn-input v-model="data.contact" name="contact" rules="required"
              ...
              <div class="group-input">
                ...
                <cpn-input v-model="data.reply_message" name="reply_message" rules="required" placeholder="กรุณาระบุ" />
              </div>
              <div class="group-input">
                <div class="name">Disclaimer <span class="required">*</span></div>
                <cpn-textArea v-model="data.disclaimer" name="disclaimer" rules="required" rows="15"
                  placeholder="กรุณาระบุ" />
              </div>
            </div>
            <div v-if="step == 2">
              <div class="sum-size-file-error" v-show="errorFileSize">
                คำเตือน: ขนาดไฟล์แนบรวม {{ data.sumfile }}MB เกินกว่า 25MB
                ระบบไม่สามารถส่งหนังสือโดยการแนบไฟล์ได้
              </div>
              <div class="sum-size-file" v-show="!errorFileSize">
                <span>ขนาดไฟล์รวม {{ data.sumfile }}MB (อนุญาตให้แนบไฟล์รวมกันสูงสุด 25MB)</span>
              </div>
              <div class="group-input">
                <div class="name">วิธีการส่งไฟล์ <span class="required">*</span></div>
                <cpn-select v-model="data.send_type_id" name="send_type_id" rules="required" :disabled="errorFileSize"
                  :optionSelect="optionSelect.send_type_id" placeholder="กรุณาระบุ" />
              </div>
              <div class="group-input">
                <div class="name">ลิงก์ดาวน์โหลดเอกสาร</div>
                <div class="group-recommend">
                  <cpn-input v-model="data.link" name="link" class="input-link" :disabled="data.send_type_id == 1"
                    :rules="errorFileSize || data.send_type_id == 2 ? 'required' : ''" placeholder="กรุณาระบุ" />
              ...
              <div class="group-input">
                ...
                <div class="d-flex" v-if="data.main_file_name">
                  <cpn-input v-model="data.main_file_name" name="main_file_name" :disabled="true" />
                  <button type="button" class="button-view"
                    @click="previewFile({ filename: data.main_file_name, link: data.main_file_path ? backendport + '/' + data.main_file_path : '' })">
                    <i class="bi bi-eye icon-eye"></i>
                  </button>
                </div>
                <div v-else>
                  <cpn-input v-model="no_main_file_name" name="no_main_file_name" :disabled="true" />
                </div>
              </div>
              <div class="line"></div>
              <div class="group-input">
                <div class="name d-flex justify-content-between align-items-center mb-3 mt-3">
                  ...
                  <input type="file" multiple @change="fileChange('attachments')" name="attachments" style="display:none;"
                ...
                <div class="d-flex mb-2" v-if="data.copy_main_file_name">
                  <cpn-input v-model="data.copy_main_file_name" name="copy_main_file_name" :disabled="true" />

                  <button type="button" class="button-view"
                    @click="previewFile({ filename: data.copy_main_file_name, link: data.copy_main_file_path ? backendport + '/' + data.copy_main_file_path : '' })">
                    <i class="bi bi-eye icon-eye"></i>
                  </button>
                </div>
                <div v-if="data?.attachments.filter(el => el.flag != 'delete')?.length > 0 || data.copy_main_file_name">
                  <div v-for="(item, index) in data.attachments" :key="index" v-show="item.flag != 'delete'">
                    <div class="d-flex mb-2">
                      <cpn-input v-model="item.filename" :name="'filename' + index" :disabled="true" />
                ...
                <div v-else>
                  <cpn-input v-model="no_attachments" name="no_attachments" :disabled="true" />
                </div>
              </div>
            </div>
            <div v-if="step == 3">
              <div class="group-input mt-4">
                ...
                <cpn-input v-model="data.subject" name="subject" rules="required" placeholder="เรื่อง" />
              </div>
              <div class="group-input mt-4">
                <div class="name">ถึง / To <span class="required">*</span> (สามารถระบุได้มากกว่า 1 อีเมล
                  โดยคั่นแต่ละอีเมลด้วยสัญลักษณ์ ,)</div>
                <cpn-input v-model="data.to" name="to" rules="required" placeholder="อีเมลผู้รับจดหมาย" />
              </div>
              <div class="group-input mt-4">
                <div class="name">สำเนาถึง / Cc (สามารถระบุได้มากกว่า 1 อีเมล โดยคั่นแต่ละอีเมลด้วยสัญลักษณ์ ,)</div>
                <cpn-input v-model="data.cc" name="cc" placeholder="อีเมลผู้รับจดหมาย" />
              </div>
              <div class="group-input mt-4">
                <div class="name">สำเนาลับถึง / BCc (สามารถระบุได้มากกว่า 1 อีเมล โดยคั่นแต่ละอีเมลด้วยสัญลักษณ์ ,)</div>
                <cpn-input v-model="data.bcc" name="bcc" placeholder="อีเมลผู้รับจดหมาย" />
              </div>
              <div class="group-input mt-4">
                <div class="name d-flex justify-content-between align-items-center mb-3 mt-3">
                                  ...
                                  <div class="col_cont" style="width:100% !important;">
                                    <div
                                      ...
                                      <div align="center" class="img-container center fixedwidth"
                                        style="padding-right: 0px;padding-left: 0px; margin-top:40px;">
                                        <a href="#" style="outline:none" tabindex="-1" target="_blank">
                                          <img align="center" alt="" border="0" class="center fixedwidth"
                                            :src="data.logoImage" width="110"
                                            style="text-decoration: none; height: auto; border: 0px; width: 100%; max-width: 110px; display: block;" />
                                        </a>
                                      </div>
                                      <div
                                        style="color:#666; font-family: 'Arial', sans-serif; line-height:1.5; padding-top:10px; padding-right:10px; padding-bottom:10px; padding-left:10px;">
                                        <div
                                          style="line-height: 2.0; font-size: 12px; color: #15466e; font-family: Arial, sans-serif; margin-bottom: 20px;">
                                          <p
                                            style="font-size: 14px; line-height: 2.0; word-break: break-word; text-align: center; margin: 0;">
                                            <strong><span style="font-size: 16px; font-weight: 500;">{{
                                              data.department_name }}</span></strong>
                                          </p>
                                          <p
                                            style="font-size: 14px; line-height: 1.0; word-break: break-word; text-align: center; margin: 0;">
                                            <strong><span
                                                style="font-size: 14px; font-weight: 400;">ระบบสารบรรณอิเล็กทรอนิกส์</span></strong>
                                          </p>
                                        </div>
                                        <div
                                          style="color:#666; font-family: 'Arial', sans-serif; line-height:1.5; padding-top:10px; padding-right:10px; padding-bottom:10px; padding-left:10px;">
                                          <div
                                            style="line-height: 2.0; font-size: 12px; color: #15466e; font-family: Arial, sans-serif; margin-bottom: 5px;">
                                            <p
                                              style="font-size: 14px; line-height: 2.0; word-break: break-word; text-align: left; margin: 0;">
                                              <strong><span style="font-size: 20px; font-weight: 600;">{{ data.greeting }}
                                                  {{ data.bookout.greeting }}</span></strong>
                                            </p>
                                          </div>
                                          <div
                                            style="line-height: 1.5; font-size: 12px; color: #333333; font-family: Arial, sans-serif;">
                                            <p
                                              style="font-size: 16px; line-height: 1.5; word-break: break-word; text-align: left; margin: 0;">
                                              {{ data.message }}
                                            </p>
                                          </div>
                                          <br>
                                          ...
                                          <div
                                            style="line-height: 2.0; font-size: 12px; color: #333333; font-family: Arial, sans-serif; margin-bottom: 5px; margin-top: 20px;">
                                            <p
                                              style="font-size: 16px; line-height: 1.5; word-break: break-word; text-align: left; margin: 0; ">
                                              {{ data.detail }}
                                            </p>
                                          ...
                                          <div
                                            style="line-height: 2.0; font-size: 12px; color: #333333; font-family: Arial, sans-serif; margin-bottom: 20px; margin-top: 20px;">
                                            <p
                                              style="font-size: 16px; line-height: 2.0; word-break: break-word; text-align: left; margin: 0; text-indent: 50px">
                                              {{ data.signature }}
                                            </p>
                                            <p
                                              style="font-size: 16px; line-height: 2.0; word-break: break-word; text-align: left; margin: 0;">
                                              {{ data.department_name }}
                                            </p>
                                          </div>
                                          <div
                                            style="line-height: 2.0; font-size: 12px; color: #333333; font-family: Arial, sans-serif; margin-bottom: 20px; margin-top: 20px; border-bottom: #030303 dashed 1px; padding-bottom: 15px;">
                                            <p
                                              style="font-size: 16px; line-height: 2.0; word-break: break-word; text-align: left; margin: 0;">
                                              {{ data.contact_name }}
                                            </p>
                                          ...
                                          <div
                                            style="line-height: 2.0; font-size: 12px; color: #333333; font-family: Arial, sans-serif; margin-bottom: 20px; margin-top: 20px;">
                                            <p
                                              style="font-size: 16px; line-height: 2.0; word-break: break-word; text-align: left; margin: 0; margin-bottom: 15px;">
                                              {{ data.reply_message }}
                                            </p>
                                            <p id="Disclaimer"
                                              style="font-size: 15px; line-height: 2.0; color: #15466e; font-style: italic; word-break: break-word; text-align: left; margin: 0;  margin-bottom: 10px"
                                              v-html="data.disclaimer"></p>
                                          </div>
                                        </div>
                                      </div>
                                    </div>
          ...
          <div class="modal-size">
            ...
            <div class="modal-detail">
              <div class="group-input">
                ...
                <cpn-autoComplete v-model="modalTemplate.message_format" name="message_format"
                  :optionSelect="modalTemplate.optionSelect.message_format" @keyup="keyupModalTeamplate($event)"
                  placeholder="กรุณาระบุ" />
              </div>
            </div>
            <div class="line"></div>
  ...
  methods: {
    ...
    sumfile() {
      ...
      if ((size / 1024 / 1024) > 25) {
        ...
        this.data.send_type_id = 2
      } else {
        this.errorFileSize = false
      }
      this.data.sumfile = (size / 1024 / 1024).toFixed(2)
    },
    cancelClick() {
