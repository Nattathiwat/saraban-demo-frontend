              ...
              <tbody class="tbody" :class="data.table.length > 0 ? 'tbody-top' : ''">
                <tr class="tbody-row" v-for="(item, index) in data.table" :key="index">
                  ...
                  <td class="col3">
                    ...
                    <div class="new-line">
                      <div class="name">คำลงท้าย</div>
                      <cpn-input v-model="item.signature" :name="'signature' + index" />
                    </div>
                    <div class="new-line">
                      <div class="name">ชื่อหน่วยงานที่ส่งหนังสือ</div>
                      <cpn-input v-model="item.department_name" :name="'department_name' + index" />
                    </div>
                    <div class="new-line">
                      <div class="name">ข้อมูลผู้ติดต่อ</div>
                      <cpn-input
                  ...
                  <td class="col4">
                    <div class="new-line">
                      ...
                      <cpn-input v-model="item.to" rules="required" :name="'to' + index" />
                    </div>
                    <div class="new-line">
                      <div class="name">สำเนาถึง (Cc)</div>
                      <cpn-input v-model="item.cc" :name="'cc' + index" />
                    </div>
                    <div class="new-line">
                      <div class="name">สำเนาลับถึง (Bcc)</div>
                      <cpn-input v-model="item.bcc" :name="'bcc' + index" />
                    </div>
                    <div class="new-line">
                      <div class="name">เรื่อง</div>
                      <cpn-input v-model="item.subject" :name="'subject' + index" />
                    </div>
                    <div class="new-line">
                      <div class="name">ข้อความ</div>
                      <cpn-textArea v-model="item.message" :name="'message' + index" rows="5" />
                    </div>
                  </td>
                  <td class="col5">
                    ...
                    <div class="new-line">
                      ...
                      <div v-else>
                        <cpn-input v-model="noData" :name="'noData' + index" :disabled="true" />
                      </div>
                    </div>
                  </td>
                </tr>
