      ...
      <div class="detail-history" v-if="$route.params.id">
        <div class="history" >
          ...
          <div class="content" v-show="data.history.hide">
            ...
            <div class="content-detail" v-for="(item, index) in data.history.data.filter(el => data.history.tab == 2 ? el.type == 2 : data.history.tab == 3 ? (el.type == 0 || el.type == 0) : el)" :key="index" :class="index == 0 ? 'first' : index == (data.history.data.length-1) ? 'end' : ''">
