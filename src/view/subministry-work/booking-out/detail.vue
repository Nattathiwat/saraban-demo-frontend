  ...
  methods: {
    ...
    call_api_save(data) {
      ...
      let dataSave = {
        ...
        flag: this.flagSave == 1 ? 'draft' : this.flagSave == 2 ? 'update_send_to' : this.flagSave == 3 ? 'update' : this.flagSave == 5 ? 'update' : this.flagSave == 6 ? 'update_send_style' : (this.flagSave == 4 && this.edit) ? 'update' : 'draft',
