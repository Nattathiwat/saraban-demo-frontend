  ...
  computed: {
    breadcrumbs() {
      if (this.$route.name == "user-manage") {
        ...
        if (!this.rule?.user1) this.defaultUrl();
        return [
          { name: "การจัดการผู้ใช้งาน", path: "user-manage" },
          {
            name: "แก้ไขผู้ใช้งาน",
        ...
        return [
          { name: "การจัดการผู้ใช้งาน", path: "user-manage" },
          { name: "เพิ่มผู้ใช้งาน", path: "user-manage-create" },
        ];
      } else if (this.$route.name == "book-type") {
        if (!this.rule?.user1) this.defaultUrl();
        return [
          { name: "มาสเตอร์", path: "" },
          { name: "ชนิดหนังสือ", path: "book-type" },
        ];
        ...
        return [
          { name: "มาสเตอร์", path: "" },
          { name: "ชนิดหนังสือ", path: "book-type" },
          { name: "เพิ่มชนิดหนังสือ", path: "book-type-create" },
        ];
      } else if (this.$route.name == "record-type") {
        if (!this.rule?.user1) this.defaultUrl();
        return [
          { name: "มาสเตอร์", path: "" },
          { name: "ชนิดบันทึกข้อความ", path: "record-type" },
        ];
        ...
        return [
          ...
          { name: "ชนิดบันทึกข้อความ", path: "record-type" },
          {
            name: "แก้ไขชนิดบันทึกข้อความ",
            path: "record-type-edit",
            query: this.$route.query,
          },
        ];
        ...
        return [
          { name: "มาสเตอร์", path: "" },
          { name: "ชนิดบันทึกข้อความ", path: "record-type" },
          { name: "เพิ่มชนิดบันทึกข้อความ", path: "record-type-create" },
        ];
      } else if (this.$route.name == "book-record") {
        if (!this.rule?.user1) this.defaultUrl();
        return [
          { name: "มาสเตอร์", path: "" },
          { name: "ทะเบียนหนังสือ", path: "book-record" },
        ];
        ...
        return [
          ...
          { name: "ทะเบียนหนังสือ", path: "book-record" },
          {
            name: "แก้ไขทะเบียนหนังสือ",
            path: "book-record-edit",
            query: this.$route.query,
          },
        ];
        ...
        return [
          { name: "มาสเตอร์", path: "" },
          { name: "ทะเบียนหนังสือ", path: "book-record" },
          { name: "เพิ่มทะเบียนหนังสือ", path: "book-record-create" },
        ];
      } else if (this.$route.name == "organization") {
        if (!this.rule?.user1) this.defaultUrl();
        return [
          { name: "มาสเตอร์", path: "" },
          { name: "กระทรวง", path: "organization" },
        ];
        ...
        return [
          { name: "มาสเตอร์", path: "" },
          { name: "กระทรวง", path: "organization" },
          { name: "เพิ่มกระทรวง", path: "organization-create" },
        ];
      } else if (this.$route.name == "agency") {
        if (!this.rule?.user1) this.defaultUrl();
        return [
          { name: "มาสเตอร์", path: "" },
          { name: "หน่วยงาน", path: "agency" },
        ];
        ...
        return [
          { name: "มาสเตอร์", path: "" },
          { name: "หน่วยงาน", path: "agency" },
          { name: "เพิ่มหน่วยงาน", path: "agency-create" },
        ];
      } else if (this.$route.name == "subministry") {
        if (!this.rule?.user1) this.defaultUrl();
        return [
          { name: "มาสเตอร์", path: "" },
          { name: "กอง", path: "subministry" },
        ];
        ...
        return [
          { name: "มาสเตอร์", path: "" },
          { name: "กอง", path: "subministry" },
          { name: "เพิ่มกอง", path: "subministry-create" },
        ];
      } else if (this.$route.name == "group") {
        if (!this.rule?.user1) this.defaultUrl();
        return [
          { name: "มาสเตอร์", path: "" },
          { name: "กลุ่ม", path: "group" },
        ];
        ...
        return [
          { name: "มาสเตอร์", path: "" },
          { name: "กลุ่ม", path: "group" },
          { name: "แก้ไขกลุ่ม", path: "group-edit", query: this.$route.query },
        ];
        ...
        return [
          { name: "มาสเตอร์", path: "" },
          { name: "กลุ่ม", path: "group" },
          { name: "เพิ่มกลุ่ม", path: "group-create" },
        ];
      } else if (this.$route.name == "book-method") {
        if (!this.rule?.user1) this.defaultUrl();
        return [
          { name: "มาสเตอร์", path: "" },
          { name: "รูปแบบการรับ-ส่งหนังสือ", path: "book-method" },
        ];
        ...
        return [
          ...
          { name: "รูปแบบการรับ-ส่งหนังสือ", path: "book-method" },
          {
            name: "แก้ไขรูปแบบการรับ-ส่งหนังสือ",
            path: "book-method-edit",
            query: this.$route.query,
          },
        ];
        ...
        return [
          { name: "มาสเตอร์", path: "" },
          { name: "รูปแบบการรับ-ส่งหนังสือ", path: "book-method" },
          { name: "เพิ่มรูปแบบการรับ-ส่งหนังสือ", path: "book-method-create" },
        ];
      } else if (this.$route.name == "file") {
        if (!this.rule?.user1) this.defaultUrl();
        return [
          { name: "มาสเตอร์", path: "" },
          { name: "ตั้งค่าประเภทไฟล์", path: "file" },
        ];
        ...
        return [
          { name: "มาสเตอร์", path: "" },
          { name: "ตั้งค่าประเภทไฟล์", path: "file" },
          { name: "เพิ่มตั้งค่าประเภทไฟล์", path: "file-create" },
        ];
      } else if (this.$route.name == "my-work.waiting-booking-receive") {
        if (!(this.rule?.user1 || this.rule?.user3)) this.defaultUrl();
        return [
          { name: "งานรับ-ส่งหนังสือ", path: "my-work" },
          { name: "หนังสือรอรับเข้า", path: "my-work.waiting-booking-receive" },
        ];
        ...
        return [
          ...
          { name: "หนังสือรอรับเข้า", path: "my-work.waiting-booking-receive" },
          {
            name: "สร้างหนังสือรอรับเข้า",
            path: "my-work.waiting-booking-receive-create",
          },
        ];
        ...
        return [
          ...
          { name: "หนังสือรอรับเข้า", path: "my-work.waiting-booking-receive" },
          {
            name: "แก้ไขหนังสือรอรับเข้า",
            path: "my-work.waiting-booking-receive-edit",
            query: this.$route.query,
          },
        ];
        ...
        return [
          { name: "งานรับ-ส่งหนังสือ", path: "my-work" },
          { name: "หนังสือรับเข้า", path: "my-work.booking-receive" },
        ];
        ...
        return [
          ...
          { name: "หนังสือรับเข้า", path: "my-work.booking-receive" },
          {
            name: "สร้างหนังสือรับเข้า",
            path: "my-work.booking-receive-create",
          },
        ];
        ...
        return [
          ...
          { name: "หนังสือรับเข้า", path: "my-work.booking-receive" },
          {
            name: "แก้ไขหนังสือรับเข้า",
            path: "my-work.booking-receive-edit",
            query: this.$route.query,
          },
        ];
        ...
        return [
          { name: "งานรับ-ส่งหนังสือ", path: "my-work" },
          { name: "หนังสือส่งออก", path: "my-work.booking-out" },
        ];
        ...
        return [
          { name: "งานรับ-ส่งหนังสือ", path: "my-work" },
          { name: "หนังสือส่งออก", path: "my-work.booking-out" },
          { name: "สร้างหนังสือส่งออก", path: "my-work.booking-out-create" },
        ];
        ...
        return [
          ...
          { name: "หนังสือส่งออก", path: "my-work.booking-out" },
          {
            name: "แก้ไขหนังสือส่งออก",
            path: "my-work.booking-out-edit",
            query: this.$route.query,
          },
        ];
      } else if (this.$route.name == "subministry-work.booking-receive") {
        if (!(this.rule?.user1 || this.rule?.user2 || this.rule?.user4))
          this.defaultUrl();
        return [
          { name: "งานของกอง", path: "subministry-work" },
          { name: "หนังสือรับเข้า", path: "subministry-work.booking-receive" },
        ];
      } else if (
        this.$route.name == "subministry-work.booking-receive-create"
      ) {
        if (!(this.rule?.user1 || this.rule?.user2 || this.rule?.user4))
          this.defaultUrl();
        return [
          ...
          {
            name: "สร้างหนังสือรับเข้า",
            path: "subministry-work.booking-receive-create",
          },
        ];
        ...
        return [
          ...
          {
            name: "แก้ไขหนังสือรับเข้า",
            path: "subministry-work.booking-receive-edit",
            query: this.$route.query,
          },
        ];
        ...
        return [
          { name: "งานของกอง", path: "subministry-work" },
          { name: "หนังสือส่งออก", path: "subministry-work.booking-out" },
        ];
        ...
        return [
          ...
          { name: "หนังสือส่งออก", path: "subministry-work.booking-out" },
          {
            name: "สร้างหนังสือส่งออก",
            path: "subministry-work.booking-out-create",
          },
        ];
        ...
        return [
          ...
          {
            name: "แก้ไขหนังสือส่งออก",
            path: "subministry-work.booking-out-edit",
            query: this.$route.query,
          },
        ];
        ...
        return [
          { name: "งานของกอง", path: "subministry-work" },
          { name: "บันทึกรับเข้า", path: "subministry-work.record-receive" },
        ];
        ...
        return [
          ...
          { name: "บันทึกรับเข้า", path: "subministry-work.record-receive" },
          {
            name: "สร้างบันทึกรับเข้า",
            path: "subministry-work.record-receive-create",
          },
        ];
        ...
        return [
          ...
          { name: "บันทึกรับเข้า", path: "subministry-work.record-receive" },
          {
            name: "แก้ไขบันทึกรับเข้า",
            path: "subministry-work.record-receive-edit",
            query: this.$route.query,
          },
        ];
        ...
        return [
          { name: "งานของกอง", path: "subministry-work" },
          { name: "บันทึกส่งออก", path: "subministry-work.record-out" },
        ];
        ...
        return [
          ...
          { name: "บันทึกส่งออก", path: "subministry-work.record-out" },
          {
            name: "สร้างบันทึกส่งออก",
            path: "subministry-work.record-out-create",
          },
        ];
        ...
        return [
          ...
          { name: "บันทึกส่งออก", path: "subministry-work.record-out" },
          {
            name: "แก้ไขบันทึกส่งออก",
            path: "subministry-work.record-out-edit",
            query: this.$route.query,
          },
        ];
        ...
        return [
          { name: "มาสเตอร์", path: "" },
          { name: "อีเมลติดต่อหน่วยงาน", path: "automail-mail-addresses" },
        ];
        ...
        return [
          { name: "มาสเตอร์", path: "" },
          {
            name: "ตั้งค่ารูปแบบข้อความตามผู้รับจดหมาย",
            path: "automail-receiver-profile",
          },
        ];
        ...
        return [
          ...
          {
            name: "สร้างตั้งค่ารูปแบบข้อความตามผู้รับจดหมาย",
            path: "automail-receiver-profile-create",
          },
        ];
        ...
        return [
          ...
          {
            name: "แก้ไขตั้งค่ารูปแบบข้อความตามผู้รับจดหมาย",
            path: "automail-receiver-profile-edit",
            query: this.$route.query,
          },
        ];
        ...
        if (!(this.rule?.user1 || this.rule?.user2 || this.rule?.user4))
          this.defaultUrl();
        return [
          { name: "รายการส่งอีเมล", path: "" },
          {
            name: "บันทึกการส่งอีเมลอัตโนมัติ",
            path: "automail-sendmail-logs",
          },
        ];
        ...
        return [
          { name: "รายการส่งอีเมล", path: "" },
          {
            name: "รายการหนังสือส่งออก ที่ส่งผ่านอีเมลอัตโนมัติ",
            path: "automail-sendmail",
          },
        ];
        ...
        return [
          ...
          {
            name: "ส่งหนังสือส่งออก ผ่านอีเมลอัตโนมัติ",
            path: "automail-sendmail-list",
            query: this.$route.query,
          },
        ];
        ...
        return [
          { name: "มาสเตอร์", path: "" },
          { name: "ตั้งค่าอีเมลสำหรับส่งหนังสือ", path: "email-agency" },
        ];
        ...
        return [
          ...
          { name: "ตั้งค่าอีเมลสำหรับส่งหนังสือ", path: "email-agency" },
          {
            name: "สร้างอีเมลสำหรับส่งหนังสือของหน่วยงาน",
        ...
        return [
          ...
          { name: "ตั้งค่าอีเมลสำหรับส่งหนังสือ", path: "email-agency" },
          {
            name: "แก้ไขอีเมลสำหรับส่งหนังสือของหน่วยงาน",
            path: "email-agency-edit",
            query: this.$route.query,
          },
        ];
      } else {
  ...
  methods: {
    ...
    checkPathRoute() {
      if (this.$route.name == "login") {
        ...
        if (
          this.$router.options.history.state.back == "/login" ||
          !this.data.logoImage
        ) {
          if (
            !(
            ...
            this.data.logoImage = new URL(
              `@/assets/images/default/department.png`,
              import.meta.url
            ).href;
          }
          if (!!localStorage.getItem("profile_img")) {
            ...
            this.dataUser.image = new URL(
              `@/assets/images/default/profile_img.jpg`,
              import.meta.url
            ).href;
          }
        }
      ...
      this.axios({
        ...
        .then((response3) => {
          const blob = new Blob([response3.data], {
            type: this.assetsUtils.getTypeFile(filename),
          });
