        ...
        <div v-if="!hamburger" class="navigation">
          ...
          <div class="group-list-head">
            ...
            <div class="list-navbar-group" v-if="rule?.user1 || rule?.user2 || rule?.user4">
              <div class="list-navbar pointer" :class="routePath('/subministry-work/') ? 'active' : ''"
                @click="removeSelect(), $router.push({ name: 'subministry-work' })">
                <div class="group-image">
                  <img class="icon-square" src="@/assets/images/navbar/square.svg">
                  <img class="icon-memo" src="@/assets/images/navbar/memo-pad-duotone.svg">
                </div>
            ...
            <div class="list-navbar-group" v-if="false">
              <div class="list-navbar pointer"
                @click="removeSelect('automail'), iconAngle.automail = !iconAngle.automail">
                <div class="group-image">
            ...
            <div class="list-navbar-group" v-if="rule?.user1 || rule?.user2 || rule?.user4">
              <div class="list-navbar pointer" :class="routePath('/automail/sendmail') ? 'active' : ''"
                @click="removeSelect('automail'), iconAngle.automail = !iconAngle.automail">
                <div class="group-image">
                  <img src="@/assets/images/navbar/square.svg" class="icon-square">
              ...
              <div v-show="iconAngle.automail" class="list-navbar-sub pointer"
                :class="$route.name == 'automail-sendmail' || $route.name == 'automail-sendmail-list' || $route.name == 'automail-sendmail-edit' ? 'active2' : ''"
                @click="$router.push({ name: 'automail-sendmail' })">
                <div class="icon-circle"></div>
                รายการหนังสือส่งออกที่ส่งผ่านอีเมล (อัตโนมัติ)
              </div>
              <div v-show="iconAngle.automail" class="list-navbar-sub pointer"
                :class="$route.name == 'automail-sendmail-logs' ? 'active2' : ''"
            ...
            <div class="list-navbar-group" v-if="rule?.user1">
              <div class="list-navbar pointer"
                :class="$route.name == 'user-manage' || $route.name == 'user-manage-create' || $route.name == 'user-manage-edit' ? 'active' : ''"
            ...
            <div class="list-navbar-group" v-if="rule?.user1">
              <div class="list-navbar pointer" :class="routePath('/master/') ? 'active' : ''"
                @click="removeSelect('master'), iconAngle.master = !iconAngle.master">
                <div class="group-image">
                  <img src="@/assets/images/navbar/square.svg" class="icon-square">
                  <img class="icon-memo" src="@/assets/images/navbar/memo-pad-duotone.svg">
                </div>
              ...
              <div v-show="iconAngle.master" class="list-navbar-sub pointer"
                :class="$route.name == 'book-type' || $route.name == 'book-type-create' || $route.name == 'book-type-edit' ? 'active2' : ''"
                @click="$router.push({ name: 'book-type' })">
                <div class="icon-circle"></div>
                ชนิดหนังสือ
              </div>
              <div v-show="iconAngle.master" class="list-navbar-sub pointer"
                :class="$route.name == 'record-type' || $route.name == 'record-type-create' || $route.name == 'record-type-edit' ? 'active2' : ''"
                @click="$router.push({ name: 'record-type' })">
                <div class="icon-circle"></div>
                ชนิดบันทึกข้อความ
              </div>
              <div v-show="iconAngle.master" class="list-navbar-sub pointer"
                :class="$route.name == 'book-record' || $route.name == 'book-record-create' || $route.name == 'book-record-edit' ? 'active2' : ''"
                @click="$router.push({ name: 'book-record' })">
                <div class="icon-circle"></div>
                ทะเบียนหนังสือ
              </div>
              <div v-show="iconAngle.master" class="list-navbar-sub pointer"
                :class="$route.name == 'organization' || $route.name == 'organization-create' || $route.name == 'organization-edit' ? 'active2' : ''"
                @click="$router.push({ name: 'organization' })">
                <div class="icon-circle"></div>
                กระทรวง
              </div>
              <div v-show="iconAngle.master" class="list-navbar-sub pointer"
                :class="$route.name == 'agency' || $route.name == 'agency-create' || $route.name == 'agency-edit' ? 'active2' : ''"
                @click="$router.push({ name: 'agency' })">
                <div class="icon-circle"></div>
                หน่วยงาน
              </div>
              <div v-show="iconAngle.master" class="list-navbar-sub pointer"
                :class="$route.name == 'subministry' || $route.name == 'subministry-create' || $route.name == 'subministry-edit' ? 'active2' : ''"
                @click="$router.push({ name: 'subministry' })">
                <div class="icon-circle"></div>
                กอง
              </div>
              <div v-show="iconAngle.master" class="list-navbar-sub pointer"
                :class="$route.name == 'group' || $route.name == 'group-create' || $route.name == 'group-edit' ? 'active2' : ''"
                @click="$router.push({ name: 'group' })">
                <div class="icon-circle"></div>
                กลุ่ม
              </div>
              <div v-show="iconAngle.master" class="list-navbar-sub pointer"
                :class="$route.name == 'book-method' || $route.name == 'book-method-create' || $route.name == 'book-method-edit' ? 'active2' : ''"
                @click="$router.push({ name: 'book-method' })">
                <div class="icon-circle"></div>
                รูปแบบการรับ-ส่งหนังสือ
              </div>
              <div v-show="iconAngle.master" class="list-navbar-sub pointer"
                :class="$route.name == 'file' || $route.name == 'file-create' || $route.name == 'file-edit' ? 'active2' : ''"
                @click="$router.push({ name: 'file' })">
                <div class="icon-circle"></div>
                ตั้งค่าประเภทไฟล์
              </div>
              <div v-show="iconAngle.master && false" class="list-navbar-sub pointer"
                :class="$route.name == 'automail-mail-addresses' ? 'active2' : ''"
                @click="$router.push({ name: 'automail-mail-addresses' })">
                <div class="icon-circle"></div>
                ข้อมูลติดต่อหน่วยงาน
              </div>
              <div v-show="iconAngle.master && false" class="list-navbar-sub pointer"
                :class="$route.name == 'automail-receiver-profile' || $route.name == 'automail-receiver-profile-create' || $route.name == 'automail-receiver-profile-edit' ? 'active2' : ''"
                @click="$router.push({ name: 'automail-receiver-profile' })">
                <div class="icon-circle"></div>
                ตั้งค่ารูปแบบข้อความตามผู้รับจดหมาย
              </div>
              <div v-show="iconAngle.master" class="list-navbar-sub pointer"
                :class="$route.name == 'email-agency' || $route.name == 'email-agency-create' || $route.name == 'email-agency-edit' ? 'active2' : ''"
